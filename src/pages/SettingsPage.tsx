          ...
          <Card className="p-6 flex flex-col gap-5 border-border/15 bg-surface/60">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                {/* Mini Cat SVG Preview */}
                <div className={`transition-transform duration-500 ${petTheme === 'cat' ? 'scale-110' : 'scale-100 group-hover:scale-110'}`} style={{ width: 72, height: 72 }}>
                  <svg viewBox="0 0 200 200" width="72" height="72" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {/* Tail */}
                    <path d="M60 170 C40 185, 20 180, 15 150 C10 120, 30 110, 25 90 C22 80, 12 85, 15 95 C20 110, 0 120, 5 150 C10 190, 45 200, 70 180 Z" fill="url(#miniCatGrad)" stroke="#E07B00" strokeWidth="1.5" />
                    {/* Body */}
                    ...
                    {/* Left Ear */}
                    <path d="M 50 70 L 35 25 Q 40 22 50 28 L 78 52 Z" fill="url(#miniCatGrad)" stroke="#E07B00" strokeWidth="2" strokeLinejoin="round" />
                    <path d="M 47 62 L 39 33 Q 42 31 49 35 L 68 51 Z" fill="#FFB6C1" opacity="0.8" />
                    {/* Right Ear */}
                    <path d="M 150 70 L 165 25 Q 160 22 150 28 L 122 52 Z" fill="url(#miniCatGrad)" stroke="#E07B00" strokeWidth="2" strokeLinejoin="round" />
                    <path d="M 153 62 L 161 33 Q 158 31 151 35 L 132 51 Z" fill="#FFB6C1" opacity="0.8" />
                    {/* Head */}
                    ...
                    <path d="M 108 180 C 108 162, 122 162, 122 180 C 122 185, 108 185, 108 180 Z" fill="url(#miniCatGrad)" stroke="#E07B00" strokeWidth="1.5" />
                  </svg>
                </div>
              ...
              >
                ...
                {/* Mini Dog SVG Preview */}
                <div className={`transition-transform duration-500 ${petTheme === 'dog' ? 'scale-110' : 'scale-100 group-hover:scale-110'}`} style={{ width: 72, height: 72 }}>
                  <svg viewBox="0 0 200 200" width="72" height="72" xmlns="http://www.w3.org/2000/svg">
                    <defs>
