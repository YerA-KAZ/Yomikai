...
import { Trophy, Shield, Clock, ChevronUp, ChevronDown, User, Zap, Award } from 'lucide-react';
...
const mockWeeklyLeaderboard: LeaderboardUser[] = [
  { rank: 1, name: 'Hiroshi', avatar: 'H', level: 12, xp: 2450, streak: 14 },
  { rank: 2, name: 'Sakura', avatar: 'S', level: 10, xp: 1980, streak: 21 },
  { rank: 3, name: 'Yuki', avatar: 'Y', level: 8, xp: 1650, streak: 5 },
  { rank: 4, name: 'Ученик', avatar: 'У', level: 5, xp: 1250, streak: 7, isCurrentUser: true },
  { rank: 5, name: 'Kenji', avatar: 'K', level: 4, xp: 1120, streak: 3 },
  { rank: 6, name: 'Naomi', avatar: 'N', level: 4, xp: 980, streak: 10 },
  { rank: 7, name: 'Takumi', avatar: 'T', level: 3, xp: 850, streak: 0 },
  { rank: 8, name: 'Aimi', avatar: 'A', level: 3, xp: 710, streak: 2 },
  { rank: 9, name: 'Rin', avatar: 'R', level: 2, xp: 580, streak: 6 },
  { rank: 10, name: 'Daiki', avatar: 'D', level: 2, xp: 420, streak: 1 },
];

const mockAllTimeLeaderboard: LeaderboardUser[] = [
  { rank: 1, name: 'Sakura', avatar: 'S', level: 18, xp: 14500, streak: 21 },
  { rank: 2, name: 'Hiroshi', avatar: 'H', level: 15, xp: 12800, streak: 14 },
  { rank: 3, name: 'Yuki', avatar: 'Y', level: 11, xp: 9400, streak: 5 },
  { rank: 4, name: 'Kenji', avatar: 'K', level: 9, xp: 7200, streak: 3 },
  { rank: 5, name: 'Ученик', avatar: 'У', level: 5, xp: 5250, streak: 7, isCurrentUser: true },
  { rank: 6, name: 'Naomi', avatar: 'N', level: 7, xp: 4980, streak: 10 },
  { rank: 7, name: 'Takumi', avatar: 'T', level: 6, xp: 3850, streak: 0 },
  { rank: 8, name: 'Rin', avatar: 'R', level: 5, xp: 3120, streak: 6 },
  { rank: 9, name: 'Aimi', avatar: 'A', level: 4, xp: 2710, streak: 2 },
  { rank: 10, name: 'Daiki', avatar: 'D', level: 3, xp: 1950, streak: 1 },
];
...
export const LeaderboardPage: React.FC = () => {
  ...
  const currentLeaderboard = activeTab === 'weekly' ? mockWeeklyLeaderboard : mockAllTimeLeaderboard;
  const podiumUsers = currentLeaderboard.slice(0, 3);
