...
import { User, Sun, Moon, Home, Languages, BookOpen, GraduationCap, Award, Settings, Search, ChevronDown, Trophy, type LucideIcon } from 'lucide-react';
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className={`p-2 rounded-xl transition-colors border border-transparent relative overflow-hidden group ${
            location.pathname === '/profile' ? 'bg-primary/10 text-primary border-primary/20' : 'bg-surface border-border/50 hover:bg-surface-hover text-text'
          }`}
